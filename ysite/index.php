	...
	<body class="body-netim">
		...
		<section class="encarts">
			<article>
				...
				<div>
					<a class="btn btn-info" href="<?php echo $categories_url ?>"><?php echo $categories_text_btn ?></a>
				</div>
			</article>
			<article>
				<div>
				...
				<div>
					<a class="btn btn-info" href="<?php echo $promos_url ?>"><?php echo $promos_text_btn ?></a>
				</div>
			</article>
			<article>
				<div>
				...
				<div>
					<a class="btn btn-info" href="<?php echo $hosting_url ?>"><?php echo $hosting_text_btn ?></a>
				</div>
			</article>
		</section>
		...
		<section class="section-contact">
			<div>
				<a class="btn btn-action" href="<?php echo $report_url ?>"><?php echo $report_txt ?></a>
			</div>
		</section>
